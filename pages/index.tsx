...
const Home: NextPage = () => {	
	...
	// const buttonStyling = "bg-green text-white font-bold text-4xl px-7 py-3 b-7 rounded-md";
			...
			<div className="m-0 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
				<div className="flex flex-col">
					...
					<Link href={{
						...
						<button className="border-2 border-green text-darkblue text-2xl px-2 py-2 mr-7 mt-10 rounded-md">Staff</button>
					</Link>
				</div>
			</div>
		</div>
